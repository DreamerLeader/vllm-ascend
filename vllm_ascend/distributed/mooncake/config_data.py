...
class ChunkedTokenDatabase():
    ...
    def __init__(self,
                 ...
                 local_head_indices: Optional[List[int]] = None):
        ...
        self.local_head_indices = local_head_indices
    ...
    def process_tokens(
        ...
        for chunk_id, hash_val in enumerate(block_hashes):
            ...
            if start_idx < mask_num:
                ...
                if self.local_head_indices:
                    for head_idx in self.local_head_indices:
                        new_meta = replace(self.metadata,
                                           head_or_tp_rank=head_idx)
                        yield start_idx, end_idx, PoolKey(
                            new_meta, hash_val), head_idx
                else:
