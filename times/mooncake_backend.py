...
from vllm_ascend.distributed.kv_transfer.kv_pool.ascend_store._perf_log import TimedSection
...
class MooncakeBackend(Backend):
    ...
    def exists(self, keys: list[str]) -> list[int]:
        ...
        with TimedSection("lower", "batch_is_exist", len(keys)):
    ...
    def put(self, keys: list[str], addrs: list[list[int]], sizes: list[list[int]]):
        try:
            ...
            with TimedSection("lower", "batch_put_from_multi_buffers", len(keys)):
    ...
    def get(self, keys: list[str], addrs: list[list[int]], sizes: list[list[int]]):
        ...
        try:
            with TimedSection("lower", "batch_get_into_multi_buffers", len(keys)):
